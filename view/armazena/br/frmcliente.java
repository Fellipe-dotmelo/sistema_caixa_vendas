...
public class frmcliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelaClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NOME", "RG", "CPF", "E-MAIL", "CELULAR", "RESIDENCIAL", "CÓDIGO POSTAL", "ENDEREÇO", "NÚMERO", "COMPLEMENTO", "BAIRRO", "CIDADE", "UF"
            }
        ));
        ...
        painel_janelas.addTab("CONSULTA DADOS CLIENTES", painel_consulta);
        ...
        painel_janelas.addTab("DADOS PESSOAIS DOS CLIENTES", painel_dados_pessoais);
    ...
    private void txtpesquisaidKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtpesquisaidKeyPressed
        ...
        ClientesDAO dao = new ClientesDAO();
        List<Clientes> lista = dao.buscaClienteId(id);
        DefaultTableModel dados = (DefaultTableModel) tabelaClientes.getModel();
        dados.setNumRows(0);
